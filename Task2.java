...
public class Task2 {
    ...
    private static final int MAX_RANGE = 100;//fixing maximum range
    private static final int MAX_ATTEMPTS = 10;//number of attempts player can guess the number
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= MAX_ROUNDS; i++) {
            ...
            while (attempts < MAX_ATTEMPTS) {
                System.out.println("Enter your guess : ");46
